...
('template_fingerprint_johndoe_device_001', 'v1.0', 'device_001', 'Fingerprint Scanner A', 'fingerprint',
    (SELECT USER_ID FROM USERS WHERE EMAIL = 'johndoe@example.com')),
...
('template_fingerprint_janedoe_device_002', 'v1.0', 'device_002', 'Fingerprint Scanner B', 'fingerprint',
    (SELECT USER_ID FROM USERS WHERE EMAIL = 'janedoe@example.com')),
('template_face_bobsmith_device_003', 'v1.0', 'device_003', 'Face Detector C', 'face',
    (SELECT USER_ID FROM USERS WHERE EMAIL = 'bobsmith@example.com'));
...
BEGIN
    SELECT USER_ID INTO v_user_id FROM USERS WHERE EMAIL = 'johndoe@example.com';
...
DECLARE
    ...
    v_account_id UUID;
BEGIN
    SELECT USER_ID INTO v_user_id FROM USERS WHERE EMAIL = 'janedoe@example.com';
...
DECLARE
    ...
    v_account_id UUID;
BEGIN
    SELECT USER_ID INTO v_user_id FROM USERS WHERE EMAIL = 'bobsmith@example.com';
