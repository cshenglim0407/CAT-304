...
CREATE TABLE ACCOUNTS (
    ...
    CONSTRAINT initial_balance_nonnegative CHECK (INITIAL_BALANCE >= 0),
    CONSTRAINT current_balance_nonnegative CHECK (CURRENT_BALANCE >= 0)
);
...
CREATE TABLE TRANSACTION (
    ...
    CONSTRAINT spent_at_not_future CHECK (DATE(SPENT_AT) <= CURRENT_DATE)
);
...
CREATE TABLE DETAILED (
    ...
    CONSTRAINT detailed_employment_stat_options CHECK (EMPLOYMENT_STAT IN ('EMPLOYED', 'SELF-EMPLOYED', 'UNEMPLOYED', 'STUDENT', 'RETIRED', 'OTHER', 'PREFER-NOT-TO-ANSWER') OR EMPLOYMENT_STAT IS NULL),
    CONSTRAINT detailed_marital_stat_options CHECK (MARITAL_STAT IN ('SINGLE', 'MARRIED', 'DIVORCED', 'PREFER-NOT-TO-ANSWER') OR MARITAL_STAT IS NULL),
