                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      ...
                      style: AppTypography.headline3.copyWith(color: Colors.black87),
                    ),
                  ],
                ),
              ),
                ...
                child: ListView(
                  ...
                  children: const [
                    _SuggestionTile(
                      ...
                      body: "Your spending on 'Food & Dining' is 15% higher than your average for this week.",
                      icon: Icons.warning_amber_rounded,
                      color: Colors.orange,
                    ),
                    _SuggestionTile(
                      title: "Savings Opportunity",
                      body: "Based on your cash flow, you could safely move \$300 to your savings account today.",
                      icon: Icons.savings_outlined,
                      color: Colors.green,
                    ),
                    _SuggestionTile(
                      title: "Subscription Alert",
                      body: "You have a recurring payment for 'Streaming Service' coming up tomorrow.",
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  body,
                  style: AppTypography.bodySmall.copyWith(color: AppColors.greyText, height: 1.4),
                ),
              ],
            ),
          ),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Icon(Icons.keyboard_arrow_down, size: 16, color: AppColors.greyText),
                    ],
                  ),
                ),
                itemBuilder: (context) => [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    currentData['pct'],
                    style: AppTypography.labelLarge.copyWith(color: currentData['pctColor']),
                  ),
                  Text(
                    currentData['compare'],
                    style: AppTypography.caption.copyWith(color: AppColors.greyText),
            ...
            child: Row(
              children: [
                Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("\$8,000", style: AppTypography.caption.copyWith(fontSize: 10, color: AppColors.greyText)),
                    Text("\$6,000", style: AppTypography.caption.copyWith(fontSize: 10, color: AppColors.greyText)),
                    Text("\$4,000", style: AppTypography.caption.copyWith(fontSize: 10, color: AppColors.greyText)),
                    Text("\$2,000", style: AppTypography.caption.copyWith(fontSize: 10, color: AppColors.greyText)),
                    Text("\$0", style: AppTypography.caption.copyWith(fontSize: 10, color: AppColors.greyText)),
                  ],
                ),
                const SizedBox(width: 12),
                Expanded(
...
class _ExpenseDistributionCard extends StatefulWidget {
  ...
  @override
  State<_ExpenseDistributionCard> createState() => _ExpenseDistributionCardState();
}
...
class _ExpenseDistributionCardState extends State<_ExpenseDistributionCard> {
  ...
  Future<void> _pickDateRange() async {
    ...
    final newRange = await showDateRangePicker(
      ...
      lastDate: today, // FIX: Use 'today' (midnight), matching the initial range end
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Icon(Icons.calendar_today_rounded, size: 14, color: AppColors.greyText),
                    ],
                  ),
                ),
              ),
          ...
          const SizedBox(height: 30),
          const _LegendItem(color: AppColors.primary, label: "Operations", pct: "35%", amt: "(\$54,600)"),
          const SizedBox(height: 12),
          _LegendItem(color: AppColors.primary.withOpacity(0.8), label: "Marketing", pct: "25%", amt: "(\$39,000)"),
          const SizedBox(height: 12),
          _LegendItem(color: AppColors.primary.withOpacity(0.6), label: "Payroll", pct: "20%", amt: "(\$31,200)"),
          const SizedBox(height: 12),
          _LegendItem(color: AppColors.primary.withOpacity(0.4), label: "IT & Tools", pct: "12%", amt: "(\$18,700)"),
          const SizedBox(height: 12),
          _LegendItem(color: AppColors.primary.withOpacity(0.2), label: "Others", pct: "8%", amt: "(\$12,500)"),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const Spacer(),
        Text(pct, style: AppTypography.labelLarge.copyWith(fontWeight: FontWeight.bold)),
        const SizedBox(width: 4),
        Text(amt, style: AppTypography.bodyMedium.copyWith(color: AppColors.greyText)),
      ],
    );
  }
}
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final fillPaint = Paint()
      ...
      ..shader = LinearGradient(
        colors: [AppColors.primary.withOpacity(0.2), Colors.white.withOpacity(0)],
...
class _DynamicBarChartPainter extends CustomPainter {
  ...
  _DynamicBarChartPainter({required this.incomeData, required this.expenseData});
